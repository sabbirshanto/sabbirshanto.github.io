...
* Github URL: [Project](https://github.com/suaiba04/heart-disease-prediction)
...
* Technologies/Tools: ySpark (SparkConf, SparkContext, SQLContext, Spark SQL), HDFS (bdrenhdfs client), Python (logging, random), Pandas-style aggregations via Spark, Linux CLI
* Github URL: [Project](https://github.com/suaiba04/heart-disease-prediction)
